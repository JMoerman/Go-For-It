...
*/
public class GOFI.RecurrenceIterator : Object {
    private GOFI.RecurrenceFrequency freq;
    ...
    public RecurrenceIterator (RecurrenceRule rec, DateTime date) {
        freq = rec.freq;
    ...
    private bool set_next () {
        switch (freq) {
            case GOFI.RecurrenceFrequency.DAILY_RECURRENCE:
